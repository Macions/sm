...
const createMember = async (req, res) => {
    try {
        ...
        const { firstName, lastName, email, phone, function: func, team, province, status, joinDate, interests, skills, smAreas, contacts, trainingAreas, contributionInfo, } = req.body;
        // Walidacja
        ...
        const user = await prisma.user.create({
            data: {
                ...
                role_id: 4,
                username: username,
                password_hash: await bcrypt_1.default.hash("temporary123", 10),
                is_active: true,
