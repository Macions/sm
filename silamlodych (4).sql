...
--
-- Host: 127.0.0.1
-- Generation Time: Lip 24, 2026 at 12:07 AM
...
CREATE TABLE `leaves` (
  ...
  `affected_teams` longtext DEFAULT NULL,
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
  `reason` text DEFAULT NULL,
  `reason_visibility` varchar(50) NOT NULL DEFAULT 'private',
...
INSERT INTO `leaves` (`id`, `user_id`, `type`, `scope`, `affected_teams`, `start_date`, `end_date`, `reason`, `reason_visibility`, `status`, `attachments`, `approved_by`, `approved_at`, `created_at`, `updated_at`) VALUES
(1, 21, 'vacation', 'all', NULL, '2026-08-01', '2026-08-14', 'Urlop wypoczynkowy', 'private', 'approved', NULL, 'Maksym Marczak', '2026-07-16 09:00:00', '2026-07-15 08:30:00', '2026-07-23 21:36:34'),
(2, 35, 'vacation', 'team', '[\"Filar Symulacyjny\"]', '2026-07-20', '2026-07-22', '', 'private', 'pending', NULL, NULL, NULL, '2026-07-19 06:15:00', '2026-07-23 21:36:34'),
(3, 39, 'vacation', 'all', NULL, '2026-07-25', '2026-07-25', '', 'private', 'pending', NULL, NULL, NULL, '2026-07-18 12:20:00', '2026-07-23 21:36:34'),
(4, 31, 'vacation', 'team', '[\"Filar Projektowy\",\"Filar Konferencji i Debat\"]', '2026-08-15', '2026-08-22', '', 'private', 'pending', NULL, NULL, NULL, '2026-07-17 09:45:00', '2026-07-23 21:36:34'),
(5, 30, 'vacation', 'all', NULL, '2026-07-28', '2026-07-29', '', 'coordinators', 'rejected', NULL, 'Maksym Marczak', '2026-07-15 10:00:00', '2026-07-14 07:00:00', '2026-07-23 21:36:34'),
(6, 22, 'vacation', 'all', NULL, '2026-09-01', '2026-09-07', '', 'private', 'cancelled', NULL, 'Maksym Marczak', '2026-07-11 08:30:00', '2026-07-10 11:30:00', '2026-07-23 21:36:34'),
(7, 41, 'vacation', 'all', NULL, '2026-07-18', '2026-07-19', '', 'private', 'approved', NULL, 'Jakub Patrowicz', '2026-07-18 08:00:00', '2026-07-18 04:00:00', '2026-07-23 21:36:34'),
(8, 1, 'vacation', 'all', '[]', '2026-07-24', '2026-07-24', 'dsadsdsd', 'private', 'pending', '[]', NULL, NULL, '2026-07-23 19:53:06', '2026-07-23 19:53:06'),
(9, 1, 'vacation', 'all', '[]', '2026-07-24', '2026-07-24', 'dsa', 'private', 'pending', '[]', NULL, NULL, '2026-07-23 19:54:22', '2026-07-23 19:54:22'),
(10, 1, 'vacation', 'all', '[]', '2026-07-24', '2026-07-30', '', 'private', 'pending', '[]', NULL, NULL, '2026-07-23 19:55:22', '2026-07-23 19:55:22'),
(11, 1, 'vacation', 'all', '[]', '2026-07-24', '2026-07-30', '', 'private', 'pending', '[]', NULL, NULL, '2026-07-23 19:59:06', '2026-07-23 19:59:06'),
(12, 1, 'vacation', 'all', '[]', '2026-07-25', '2026-07-30', '', 'private', 'pending', '[]', NULL, NULL, '2026-07-23 20:00:55', '2026-07-23 20:00:55'),
(13, 1, 'vacation', 'all', '[]', '2026-07-25', '2026-07-30', '', 'private', 'pending', '[]', NULL, NULL, '2026-07-23 20:01:20', '2026-07-23 20:01:20');

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `leave_comments`
--
...
--
-- Dumping data for table `leave_comments`
--

INSERT INTO `leave_comments` (`id`, `leave_id`, `author_id`, `content`, `created_at`) VALUES
(1, 1, 1, 'Szkolenie nie jest w tym terminie. Proszę o przesunięcie lub wybór innego terminu.', '2026-07-15 08:00:00');
...
(8, 1, 'Nowy wniosek urlopowy', 'Użytkownik undefined undefined zgłosił urlop od 24.07.2026 do 24.07.2026', 'info', 0, '/leave', 'coordinator', '2026-07-23 19:53:06', '2026-07-23 19:53:06'),
(9, 1, 'Nowy wniosek urlopowy', 'Użytkownik undefined undefined zgłosił urlop od 24.07.2026 do 24.07.2026', 'info', 0, '/leave', 'coordinator', '2026-07-23 19:54:22', '2026-07-23 19:54:22'),
(10, 1, 'Nowy wniosek urlopowy', 'Użytkownik undefined undefined zgłosił urlop od 24.07.2026 do 30.07.2026', 'info', 0, '/leave', 'coordinator', '2026-07-23 19:55:22', '2026-07-23 19:55:22'),
(11, 1, 'Nowy wniosek urlopowy', 'Użytkownik undefined undefined zgłosił urlop od 24.07.2026 do 30.07.2026', 'info', 0, '/leave', 'coordinator', '2026-07-23 19:59:06', '2026-07-23 19:59:06');
...
ALTER TABLE `leaves`
  ADD PRIMARY KEY (`id`),
  ADD KEY `leaves_user_id_fkey` (`user_id`);

--
-- Indeksy dla tabeli `leave_comments`
--
ALTER TABLE `leave_comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `leave_comments_leave_id_fkey` (`leave_id`),
  ADD KEY `leave_comments_author_id_fkey` (`author_id`);
...
--
ALTER TABLE `leaves`
  ADD CONSTRAINT `leaves_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `leave_comments`
--
ALTER TABLE `leave_comments`
  ADD CONSTRAINT `leave_comments_author_id_fkey` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `leave_comments_leave_id_fkey` FOREIGN KEY (`leave_id`) REFERENCES `leaves` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
